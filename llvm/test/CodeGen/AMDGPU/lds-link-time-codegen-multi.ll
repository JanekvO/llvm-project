...
; KD uses literal 0 (linker patches it directly).
; ASM-DAG: .amdhsa_group_segment_fixed_size 0
...
define amdgpu_kernel void @kernel_one(i32 %idx) #0 {
...
define amdgpu_kernel void @kernel_two(i32 %idx) #0 {
