...
; GCN: .set indirect_2level_use_vcc_kernel.num_vgpr, max(0, indirect_use_vcc.num_vgpr)
...
; GCN: .set indirect_2level_use_flat_scratch_kernel.num_vgpr, max(0, indirect_use_flat_scratch.num_vgpr)
...
; GCN:	.set indirect_2_level_use_10_vgpr.num_vgpr, max(0, indirect_use_10_vgpr.num_vgpr)
...
; GCN:	.set indirect_2_level_use_80_sgpr.num_vgpr, max(0, indirect_use_80_sgpr.num_vgpr)
...
; GCN:	.set indirect_2_level_use_stack.num_vgpr, max(0, indirect_use_stack.num_vgpr)
...
; GCN:	.set multi_call_use_use_stack.num_vgpr, max(0, use_stack0.num_vgpr, use_stack1.num_vgpr)
; GCN:	.set multi_call_use_use_stack.num_agpr, max(0, use_stack0.num_agpr, use_stack1.num_agpr)
; GCN:	.set multi_call_use_use_stack.num_sgpr, max(33, use_stack0.num_sgpr, use_stack1.num_sgpr)
...
; GCN:	.set multi_call_with_external.num_vgpr, max(43, max_num_vgpr)
...
; GCN: NumSgprs: multi_call_with_external.num_sgpr+(extrasgprs(multi_call_with_external.uses_vcc, multi_call_with_external.uses_flat_scratch, 1))
...
; GCN: NumSgprs: usage_external.num_sgpr+(extrasgprs(usage_external.uses_vcc, usage_external.uses_flat_scratch, 1))
...
; GCN: NumSgprs: usage_external_recurse.num_sgpr+(extrasgprs(usage_external_recurse.uses_vcc, usage_external_recurse.uses_flat_scratch, 1))
...
; GCN:	.set usage_direct_recursion.num_vgpr, 1
; GCN:	.set usage_direct_recursion.num_agpr, 0
; GCN:	.set usage_direct_recursion.num_sgpr, 33
; GCN:	.set usage_direct_recursion.private_seg_size, 0
; GCN:	.set usage_direct_recursion.uses_vcc, 1
; GCN:	.set usage_direct_recursion.uses_flat_scratch, 1
; GCN:	.set usage_direct_recursion.has_dyn_sized_stack, 0
; GCN:	.set usage_direct_recursion.has_recursion, 1
; GCN:	.set usage_direct_recursion.has_indirect_call, 0
; GCN: NumSgprs: 39
; GCN: NumVgprs: 1
; GCN: ScratchSize: 0
