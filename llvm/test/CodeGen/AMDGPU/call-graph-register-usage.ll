...
; CI: NumSgprs: count_use_sgpr96_external_call.num_sgpr+(extrasgprs(count_use_sgpr96_external_call.uses_vcc, count_use_sgpr96_external_call.uses_flat_scratch, 0))
; VI-BUG: NumSgprs: 96
...
; CI: NumSgprs: count_use_sgpr160_external_call.num_sgpr+(extrasgprs(count_use_sgpr160_external_call.uses_vcc, count_use_sgpr160_external_call.uses_flat_scratch, 0))
; VI-BUG: NumSgprs: 96
...
; CI: NumSgprs: count_use_vgpr160_external_call.num_sgpr+(extrasgprs(count_use_vgpr160_external_call.uses_vcc, count_use_vgpr160_external_call.uses_flat_scratch, 0))
; VI-BUG: NumSgprs: 96
