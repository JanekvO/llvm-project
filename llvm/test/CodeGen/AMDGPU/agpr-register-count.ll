...
; GFX90A: .amdhsa_accum_offset (((((((0&(~63))|((((alignto(max(1, kernel_32_agprs.num_vgpr), 4))/4)-1)<<0))&(~65536))|(0<<16))&63)>>0)+1)*4
...
; GFX90A: .amdhsa_accum_offset (((((((0&(~63))|((((alignto(max(1, kernel_0_agprs.num_vgpr), 4))/4)-1)<<0))&(~65536))|(0<<16))&63)>>0)+1)*4
...
; GFX90A: .amdhsa_accum_offset (((((((0&(~63))|((((alignto(max(1, kernel_40_vgprs.num_vgpr), 4))/4)-1)<<0))&(~65536))|(0<<16))&63)>>0)+1)*4
...
; GFX90A: .amdhsa_accum_offset (((((((0&(~63))|((((alignto(max(1, kernel_max_gprs.num_vgpr), 4))/4)-1)<<0))&(~65536))|(0<<16))&63)>>0)+1)*4
...
; GFX90A: .amdhsa_accum_offset (((((((0&(~63))|((((alignto(max(1, kernel_call_func_32_agprs.num_vgpr), 4))/4)-1)<<0))&(~65536))|(0<<16))&63)>>0)+1)*4
...
; GFX90A: .amdhsa_accum_offset (((((((0&(~63))|((((alignto(max(1, kernel_call_undef_func.num_vgpr), 4))/4)-1)<<0))&(~65536))|(0<<16))&63)>>0)+1)*4
...
; GFX90A: COMPUTE_PGM_RSRC3_GFX90A:ACCUM_OFFSET: (((((0&(~63))|((((alignto(max(1, kernel_call_undef_func.num_vgpr), 4))/4)-1)<<0))&(~65536))|(0<<16))&63)>>0
